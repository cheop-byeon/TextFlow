...
class IdsTextFlow(Task):
    ...
    def __init__(self, max_order: int = DEFAULT_MAX_ORDER, smooth: bool = DEFAULT_SMOOTH, dataset_path: str = None, metrics: List[str] = None):
        ...
        self.smooth = smooth
        logger.info(f"Initialized IdsTextFlow with dataset: {self.DATASET_PATH}")
    ...
    def get_prompt(self, doc: Dict[str, str]) -> str:
        ...
        """
        return self.generate_prompt(doc["old_text"], doc["comments"])
    ...
    @staticmethod
    def generate_prompt(old_text: str, reviews: str) -> str:
        """Generate prompt from old text and feedback.
        ...
        Returns:
            Formatted prompt
        """
        return PROMPT_TEMPLATE.format(old_text=old_text, reviews=reviews)
